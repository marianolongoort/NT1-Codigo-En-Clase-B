...
{
    public class PersonasScaffController : Controller
    {
        private readonly MiContexto _context;

        public PersonasScaffController(MiContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonaId,Nombre,Apellido,DNI,Casado,Edad")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonaId,Nombre,Apellido,DNI,Casado,Edad")] Persona persona)
        {
