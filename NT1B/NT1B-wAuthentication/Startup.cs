...
namespace NT1B_wAuthentication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // .UseSqlServer(Configuration.GetConnectionString("ORTDBCS"))
            // );
            services.AddDbContext<MiContexto>(options =>options.UseInMemoryDatabase(databaseName: "MiBaseDeDatos"));
